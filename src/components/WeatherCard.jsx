...
<p className='flex-1 text-center p-2'>{new Date().toISOString()}</p>
<p className='flex-1 text-center p-2'>{time}</p>
</div>
<div className='w-full justify-between items-center mt-4 gap-4'>
<p className='flex-1 text-center p-2 bg-blue-600 shadow rounded-lg'>Wind Speed <p className='font-normal'>{windspeed} Km/h</p></p>
...
<div className='w-ful p-4 flex justify-center items-center text-3xl font-semibold'>
{conditions}
</div>
    </div>
  )
